...
async def parse_subtitle_file_async(file_path: str, format_type: Optional[str] = None, video_id: Optional[str] = None, lesson_id: Optional[str] = None) -> List[Dict[str, Any]]:
    """
    ...
    if format_type == 'sbv':
        return await sbv_parser.parse_file_async(file_path, video_id, lesson_id)
    elif format_type == 'srt':
        return await srt_parser.parse_file_async(file_path, video_id, lesson_id)
    elif format_type == 'vtt':
        return await vtt_parser.parse_file_async(file_path, video_id, lesson_id)
    else:
        raise ValueError(f"Unsupported subtitle format: {format_type}")

def parse_subtitle_file(file_path: str, format_type: Optional[str] = None, video_id: Optional[str] = None, lesson_id: Optional[str] = None) -> List[Dict[str, Any]]:
    """
    ...
    if format_type == 'sbv':
        return sbv_parser.parse_file(file_path, video_id, lesson_id)
    elif format_type == 'srt':
        return srt_parser.parse_file(file_path, video_id, lesson_id)
    elif format_type == 'vtt':
        return vtt_parser.parse_file(file_path, video_id, lesson_id)
    else:
        raise ValueError(f"Unsupported subtitle format: {format_type}")
