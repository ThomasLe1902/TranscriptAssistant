...
async def read_transcript_async(file: str, video_id: str = None, lesson_title: str = None):
    """Async version of read_transcript"""
    # Parse với video_id và lesson_title được truyền trực tiếp vào parser
    parsed_transcript = await parse_subtitle_file_async(file, video_id=video_id, lesson_title=lesson_title)
...
def read_transcript(file: str, video_id: str = None, lesson_title: str = None):
    # Parse với video_id và lesson_title được truyền trực tiếp vào parser
    parsed_transcript = parse_subtitle_file(file, video_id=video_id, lesson_title=lesson_title)
...
def read_transcript_with_quota_handling(file: str, video_id: str = None, lesson_title: str = None):
